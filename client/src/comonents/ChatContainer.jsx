...
import { formatMessageTime } from '../lib/utiliti';
    ...
    <div className='h-full overflow-scroll relative backdrop-blue-lg'>
      <div className='flex items-center gap-3  py-3 mx-4 border-b border-stone-500'>
        ...
        <p className='flex-1 text-lg text-white flex items-center gap-2'>
         ...
         <img onClick={()=>selectedUser(null)}  src={assets.arrow_icon} 
         className='md:hidden max-w-7'></img>
         <img src={assets.help_icon} className='max-md:hidden max-w-5'/>

    </div>
    <div className='flex flex-col h-[calc(100%-120px)] overflow-y-scroll p-3 py-6'>
      {
           ...
           && 'flex-row-reverse' }`}>
            {
              msg.image ? (
                ...
                <p className={`p-2  max-w-[200px md:text-sm 
                  font-light rounded-lg mb-8 break-all
            ...
            <div className='text-center text-xs'>
              ...
              ||assets.avatar_icon :selectedUser?.profilePic || assets.arrow_icon}
      ...
      <div className='absolute bottom-0   left-0 right-0 flex items-center gap-3  p-3'>
        <div className='flex-1 flex items-center bg-gray-100/12 px-3'>
           ...
           onClick={(e)=>e.key === "Enter" ? handleSendMessage(e): null}
