  ...
  return (
    ...
    gap-8  sm:justify-evenly  max-sm:flex-col  backdrop-blur-2xl'>
      ...
      flex-col gap-6 rounded-lg  shadow-lg'>
        ...
        {
          currState === "Sign Up" && isDataSubmited && (
            <textarea onChange={(e)=>setBio(e.target.value)} rows={4} value={bio} className='p-2  border  border-gray-500  rounded-md  focus:outline-none 
            focus:ring-2  ' placeholder='provide a short bio ..' required/>
          )
        }
